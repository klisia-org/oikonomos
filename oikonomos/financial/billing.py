...
The Sales-Invoice construction core lives here so every fee-charging path
(Course Enrollment Individual, Culminating Project Extension, ...) builds
...
Relocated from seminary into oikonomos (the financial bridge). It reads seminary
financial doctypes (Fee Category, Scholarship Award, Seminary Settings) across
the boundary — legal, since oikonomos depends on seminary.
"""
